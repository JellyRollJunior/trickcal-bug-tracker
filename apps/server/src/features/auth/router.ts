...
import {
    postSignupRequestBodySchema as signupSchema,
    postLoginRequestBodySchema as loginSchema,
} from '@/features/auth/requestBody.schema.js';
...
authRouter.get('/github/callback', authController.getGithubCallback);
